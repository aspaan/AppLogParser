...
namespace LogParser
{
    public static class Util
    {
        public static DateTime GetDateTimeInUtcFormat(DateTime dateTime)
        {
            ...
            {
                return (new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute, dateTime.Second, dateTime.Millisecond, DateTimeKind.Utc)).ToUniversalTime();
            }
